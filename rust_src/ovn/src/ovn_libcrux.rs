...
// use au_curves::bls12::*;
// // use libcrux_curve25519::curve25519_51::*;

// #[derive(core::marker::Copy, Clone, PartialEq, Eq)]
// pub struct Z_curve {
//     z_val: felem_as_words,
// }

// // impl<'a> hacspec_concordium::Deserial for Z_curve<'a> {
...
//     type Output = Self;
//     fn mul(mut self, mut y: Self) -> Self {
//         let mut result : felem_as_words = [0,0,0,0,0,0];
//         bls12_mul( &mut result, &mut self.z_val, &mut y.z_val );
//         Z_curve { z_val: result }
//     }
// }
...
//     type Output = Self;
//     fn add(mut self, mut y: Self) -> Self {
//         let mut result : felem_as_words = [0,0,0,0,0,0];
//         bls12_add( &mut result, &mut self.z_val, &mut y.z_val );
//         Z_curve { z_val: result }
//     }
// }
...
//         let mut result : felem_as_words = [0,0,0,0,0,0];
//         bls12_opp( &mut result, &mut self.z_val );
//         Z_curve { z_val: result }
//     }
// }
