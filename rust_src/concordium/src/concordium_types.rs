...
pub struct ContractState {
    pub(crate) current_contract_state_position: u32,
}

#[derive(Default)]
/// A type representing the parameter to init and receive methods.
pub struct Parameter {
    pub(crate) current_parameter_position: u32,
}
...
pub struct AttributesCursor {
    ...
    pub(crate) current_attribute_cursor_position: u32,
