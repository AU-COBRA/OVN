...
batteries                       3.8.0          A community-maintained standard library extension
...
camlidl                         1.12           Stub code generator for OCaml
...
conf-gmp-paths                  1              Virtual package relying on a GMP lib system installation
conf-mpfr-paths                 1              Virtual package relying on library MPFR installation
...
coq-concert                     dev            pinned to version dev at git+https://github.com/AU-COBRA/ConCert.git#a6c8fa81bbdaa260b876c1b0a49a90d434080178
coq-core                        8.19.2         The Coq Proof Assistant -- Core Binaries and Tools
coq-deriving                    0.2.2          Generic instances of MathComp classes
coq-elm-extraction              0.1.0          Coq extraction to Elm
...
coq-extructures                 0.4.0          Finite sets, maps, and other data structures with extensional reasoning
...
coq-mathcomp-analysis           1.10.0         An analysis library for mathematical components
coq-mathcomp-bigenough          1.0.2          A small library to do epsilon - N reasoning
coq-mathcomp-classical          1.10.0         A library for classical logic for mathematical components
coq-mathcomp-experimental-reals 1.10.0         A library for alternative real numbers for mathematical components
...
coq-mathcomp-reals              1.10.0         A library for real numbers for mathematical components
...
coq-metacoq-common              1.3.3+8.19     The common library of Template Coq and PCUIC
coq-metacoq-erasure             1.3.3+8.19     Implementation and verification of an erasure procedure for Coq
coq-metacoq-pcuic               1.3.3+8.19     A type system equivalent to Coq's and its metatheory
coq-metacoq-safechecker         1.3.3+8.19     Implementation and verification of safe conversion and typechecking algorithms for Coq
coq-metacoq-template            1.3.3+8.19     A quoting and unquoting library for Coq in Coq
coq-metacoq-template-pcuic      1.3.3+8.19     Translations between Template Coq and PCUIC and proofs of correctness
coq-metacoq-utils               1.3.3+8.19     The utility library of Template Coq and PCUIC
coq-quickchick                  2.1.0          Randomized Property-Based Testing for Coq
coq-rust-extraction             0.1.0          Coq extraction to Rust
...
dune-configurator               3.14.0         Helper library for gathering system configuration
...
ez-conf-lib                     2              Simple generator of conf-<pkg>.config files
...
merlin-lib                      4.18-414       Merlin's libraries
mlgmpidl                        1.3.0          OCaml interface to the GMP library
...
ocaml-version                   3.7.2          Manipulate, parse and generate OCaml compiler version strings
...
ppxlib                          0.32.0         Standard infrastructure for ppx rewriters
